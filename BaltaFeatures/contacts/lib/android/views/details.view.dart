...
import 'package:contacts/models/repositories/contact.repository.dart';
import 'package:contacts/shared/widgets/contact-details-description.widget.dart';
import 'package:contacts/shared/widgets/contact-details-image-widgets.dart';
    ...
    showDialog(
      ...
      builder: (ctx) {
        return new AlertDialog(
          ...
          content: new Text("Deseja excluir esse contato?"),
          actions: [
            FlatButton(
              child: Text("Cancelar"),
              onPressed: () {
